 ...
 * @author Jaggu Movies
 */
public class InvigilatorDeleteAccount extends javax.swing.JPanel {
    Admin adminFrame;
    private JPanel contentPanel;
    
    /**
     * Creates new form InvigilatorDeleteAccount
     */
    Connection con;
    Statement s;
    public InvigilatorDeleteAccount(Admin adminFrame) {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(usernameComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(63, 63, 63))
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            s.execute("delete from Invigilator where username = '" + userName + "'"); // insert some data into the table  
            usernameComboBox.removeItem(userName);
            JOptionPane.showMessageDialog(adminFrame,"Account Deleted");
            s.close();
            con.close();
